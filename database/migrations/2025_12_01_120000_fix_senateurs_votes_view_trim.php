...
{
    /**
     * Corrige la vue senateurs_votes en utilisant TRIM() pour le matricule
     * 
     * Problème : senat_senateurs_sen.senmat est de type character(6) avec padding
    ...
    public function up(): void
    {
        DB::statement("
            ...
            SELECT 
                v.votesid AS id,
                TRIM(v.senmat) AS senateur_matricule,  -- TRIM pour enlever les espaces
    ...
    {
        // Revenir à la version sans TRIM
        DB::statement("
            CREATE OR REPLACE VIEW senateurs_votes AS
            SELECT 
                v.votesid AS id,
