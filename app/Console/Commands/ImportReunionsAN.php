...
class ImportReunionsAN extends Command
{
    ...
    {
        if (!$odj || !is_array($odj)) return null;
        if (isset($odj['@xsi:nil'])) return null;
    ...
    {
        if (!$points || !is_array($points)) return null;
        if (isset($points['@xsi:nil'])) return null;
        
        // Structure plus complexe avec pointODJ
        $pointsList = $points['pointODJ'] ?? $points;
        if (!is_array($pointsList)) return null;
    ...
    {
        if (!$participants || !is_array($participants)) return null;
        if (isset($participants['@xsi:nil'])) return null;
    ...
    {
        if (!$auditionnes || !is_array($auditionnes)) return null;
        if (isset($auditionnes['@xsi:nil'])) return null;
    ...
    {
        if (!$pays || !is_array($pays)) return null;
        if (isset($pays['@xsi:nil'])) return null;
