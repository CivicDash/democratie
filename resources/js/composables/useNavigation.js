...
export function useNavigation() {
    ...
    const mesElus = computed(() => ({
        ...
        emoji: '\u{1F464}',
        activeColor: 'indigo',
        isActive: url.value.startsWith('/representants') || url.value.startsWith('/parlement/comparaison') || url.value.startsWith('/elus/maires'),
        items: [
            { href: route('representants.mes-representants'), icon: '\u{1F4CD}', title: 'Mes Representants', description: 'Selon votre localisation' },
            { href: route('elus.maires.index'), icon: '\u{1F3E0}', title: 'Trouver un maire', description: '~35 000 elus', badge: '35k', badgeColor: 'amber' },
    ...
    const institutions = computed(() => ({
        ...
        columns: [
            ...
            },
            {
                ...
                color: 'emerald',
                items: [
                    { href: route('elus.maires.index'), icon: '\u{1F3E0}', title: 'Maires', description: '~35 000 elus', badge: '35k', badgeColor: 'amber' },
                    { href: route('elections.municipales.index'), icon: '\u{1F5F3}\uFE0F', title: 'Municipales 2026', description: 'Resultats et listes' },
                ],
            },
        ],
    }));
