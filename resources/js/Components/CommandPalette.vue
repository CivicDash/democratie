...
const quickLinks = [
    ...
    { icon: "⚖️", label: "Lois", description: "Parcours législatif complet", href: "/lois", keywords: ["loi", "législation", "vote", "amendement"] },
    ...
    { icon: "📊", label: "Statistiques Élus", description: "Députés, Sénateurs, Maires", href: "/parlement/comparaison", keywords: ["statistiques", "stats", "élus"] },
