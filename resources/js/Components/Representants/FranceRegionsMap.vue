...
<template>
  <div class="relative w-full">
    ...
    >
      ...
      <!-- Bourgogne-Franche-Comté (27) - Est-Centre -->
      <path
        id="region-27"
      ...
      <!-- Auvergne-Rhône-Alpes (84) - Est-Centre-Sud -->
      <path
        id="region-84"
      ...
      <!-- Provence-Alpes-Côte d'Azur (93) - Sud-Est -->
      <path
        id="region-93"
...
<style scoped>
/* Smooth transitions pour les régions */
path {
